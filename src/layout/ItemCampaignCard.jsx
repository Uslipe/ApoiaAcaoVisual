...
export default function ItemCampaignCard({
  ...
  useEffect(() => {
    console.log(
      `🔄 Buscando imagem para campanha de itens ID: ${idCampanhaDeItens}`,
    );
    axios
      .get(
  ...
  const percentualTotalDeItens =
    quantidadeDeItens > 0
      ? ((quantidadeDoada / quantidadeDeItens) * 100).toFixed(2)
      : 0;

  return (
    <div
      className="card shadow-sm m-2 p-3 d-flex flex-column justify-content-between"
      style={{ width: "18rem", minHeight: "580px", maxHeight: "350px" }}
    >
      <div className="card-body d-flex flex-column">
            ...
            >
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M21 16v-4m0 0V5a2 2 0 0 0-2-2H8m13 9c-1.475 0-2.804.104-4 .291M3 16v3a2 2 0 0 0 2 2v0h11M3 16c1.403-.234 3.637-.293 5.945.243M3 16V5c0-.368.122-.939.5-1.377M16 21h3c.368 0 .939-.122 1.377-.5M16 21c-1.704-2.768-4.427-4.148-7.055-4.757m0 0c.927-1.073 2.24-2.084 4.055-2.85M7.341 7.5C7.14 7.728 7 8.051 7 8.5 7 9.7 8 10 8.5 10a1.66 1.66 0 0 0 1-.348M2 2l20 20"
                  fill="#3d3d3d"
                ></path>
              </svg>
              <span
        ...
        <p className="mb-1" style={{ fontSize: "0.9rem", marginTop: "7%" }}>
          {percentualTotalDeItens}% de itens enviados
        </p>
        <p className="mb-1" style={{ fontSize: "0.9rem" }}>
          Total de itens doados: {quantidadeDoada}
        </p>
        <p className="mb-1" style={{ fontSize: "0.9rem" }}>
          Itens entregues: {quantidadeDeItensEntregues} / {quantidadeDeItens}
        </p>
        <p className="mb-1" style={{ fontSize: "0.9rem" }}>
        ...
        <p
          ...
          style={{ fontSize: "0.8rem", marginTop: "7%" }}
        >
