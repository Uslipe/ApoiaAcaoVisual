...
export default function Perfil() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/buscarUsuario/${id}`, {
      headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(`http://localhost:8080/editarPerfil/${id}`, {
        nome,
        email,
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      await axios.delete(
        `http://localhost:8080/deletarUsuario/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    <div>
      ...
      <div className="container mt-4 perfil-container">
        ...
        <div className="separador mt-4 mb-4 d-flex align-items-center">
          ...
          <span className="mx-3 text"><strong>OU</strong></span>
          <div className="flex-grow-1 border-bottom"></div>
        </div>
        ...
        <div className="zona-de-perigo mt-1">
          ...
          />
          <button className="btn btn-danger mt-3" onClick={confirmDeleteAccount}>
            Excluir Conta
          </button>
        </div>
      </div>
